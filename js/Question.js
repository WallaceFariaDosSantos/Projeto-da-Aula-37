class Question {
  ...
  display(){
    ...
    this.question.html("Pergunta: - Qual o nome do líquido que contém muitos leucócitos e anticorpos? " );
    this.question.position(150, 80);
    this.option1.html("1: Plasma" );
    this.option1.position(150, 100);
    this.option2.html("2: Linfa" );
    this.option2.position(150, 120);
    this.option3.html("3: Líquido sinovial" );
    this.option3.position(150, 140);
    this.option4.html("4: N.D.A (nenhuma das alternativas)" );
